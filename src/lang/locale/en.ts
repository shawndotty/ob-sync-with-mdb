...
export default {
	LicensePurchaseInfo:
		"You need to purchase a license to use all the features of OB Sync With MDB. Please contact the author for more information. ",
	...
	IOTO_BASEROW_API_KEY_HINT: "Set The Baserow API Key",
	IOTO_BASEROW_BASE_ID: "Base ID",
	IOTO_BASEROW_BASE_ID_HINT: "Set The Baserow Base ID",
	IOTO_BASEROW_TABLE_ID: "Table ID",
	IOTO_BASEROW_TABLE_ID_HINT: "Set The Baserow Table ID",
	IOTO_BASEROW_USER_EMAIL: "User Email",
	IOTO_BASEROW_USER_EMAIL_HINT: "Set The Baserow User Email",
	IOTO_BASEROW_USER_PASSWORD: "User Password",
	IOTO_BASEROW_USER_PASSWORD_HINT: "Set The Baserow User Password",
	IOTO_NOCODB_SETTINGS: "NocoDB",
	IOTO_NOCODB_API_KEY: "API Key",
	IOTO_NOCODB_API_KEY_HINT: "Set The NocoDB API Key",
	IOTO_NOCODB_WORKSPACE_ID: "Workspace ID",
	IOTO_NOCODB_WORKSPACE_ID_HINT: "Set The NocoDB Workspace ID",
	IOTO_NOCODB_BASE_ID: "Base ID",
	IOTO_NOCODB_BASE_ID_HINT: "Set The NocoDB Base ID",
	IOTO_NOCODB_TABLE_ID: "Table ID",
	IOTO_NOCODB_TABLE_ID_HINT: "Set The NocoDB Table ID",
	...
	YourBaserowSyncTable: "Your Baserow Sync Table",
	BaserowSyncTemplate: "Baserow Sync Template",
	YourNocoDBSyncTable: "Your NocoDB Sync Table",
	NocoDBSyncTemplate: "NocoDB Sync Template",
	...
	YourBaserowFetchTable: "Your Baserow Fetch Table",
	BaserowFetchTemplate: "Baserow Fetch Template",
	YourNocoDBFetchTable: "Your NocoDB Fetch Table",
	NocoDBFetchTemplate: "NocoDB Fetch Template",
