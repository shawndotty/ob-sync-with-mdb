...
export default {
	LicensePurchaseInfo:
		"您需要购买许可证才能使用OB Sync With MDB的所有功能。请联系作者获取更多信息。",
	...
	"Update Baserow Sync Scripts": "更新Baserow同步脚本",
	"Update NocoDB Sync Scripts": "更新NocoDB同步脚本",
	...
	IOTO_BASEROW_API_KEY_HINT: "设置 Baserow API Key",
	IOTO_BASEROW_BASE_ID: "Base ID",
	IOTO_BASEROW_BASE_ID_HINT: "设置 Baserow Base ID",
	IOTO_BASEROW_TABLE_ID: "Table ID",
	IOTO_BASEROW_TABLE_ID_HINT: "设置 Baserow Table ID",
	IOTO_BASEROW_USER_EMAIL: "用户邮箱",
	IOTO_BASEROW_USER_EMAIL_HINT: "设置 Baserow 用户邮箱",
	IOTO_BASEROW_USER_PASSWORD: "用户密码",
	IOTO_BASEROW_USER_PASSWORD_HINT: "设置 Baserow 用户密码",
	IOTO_NOCODB_SETTINGS: "NocoDB",
	IOTO_NOCODB_API_KEY: "API Key",
	IOTO_NOCODB_API_KEY_HINT: "设置 NocoDB API Key",
	IOTO_NOCODB_WORKSPACE_ID: "工作空间 ID",
	IOTO_NOCODB_WORKSPACE_ID_HINT: "设置 NocoDB 工作空间 ID",
	IOTO_NOCODB_BASE_ID: "Base ID",
	IOTO_NOCODB_BASE_ID_HINT: "设置 NocoDB Base ID",
	IOTO_NOCODB_TABLE_ID: "Table ID",
	IOTO_NOCODB_TABLE_ID_HINT: "设置 NocoDB Table ID",
	...
	YourBaserowFetchTable: "您的 Baserow 获取表",
	BaserowFetchTemplate: "Baserow 获取模板",
	YourNocoDBFetchTable: "您的 NocoDB 获取表",
	NocoDBFetchTemplate: "NocoDB 获取模板",
	...
	"Turn On Only Sync Current File Mode": "开启仅同步当前文件模式",
	"Only Sync Current File Mode is On": "仅同步当前文件模式已开启",
	"Turn Off Only Sync Current File Mode": "关闭仅同步当前文件模式",
	"Only Sync Current File Mode is Off": "仅同步当前文件模式已关闭",
